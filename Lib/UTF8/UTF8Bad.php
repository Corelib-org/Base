...
/**
* Return code from UTF8Bad::bad_identify() when a five octet sequence is detected.
* Note: 5 octets sequences are valid UTF-8 but are not supported by Unicode so
* do not represent a useful character
* @see UTF8Bad::bad_identify
*/
define('UTF8_BAD_5OCTET',1);

/**
* Return code from UTF8Bad::bad_identify() when a six octet sequence is detected.
...
/**
* Return code from UTF8Bad::bad_identify().
...
class UTF8Bad extends UTF8Core {
	...
	*/
	public static function bad_explain($code) {
	    ...
	    throw new UTF8Exception('Unknown error code: '.$code);
	    return FALSE;
	}
}
?>