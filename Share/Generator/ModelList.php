 ...
 * @subpackage ${groupname}
 */
class ${classname}List implements Output,CacheableOutput {
	...
	//*****************************************************************//
	/**
	 * Create new ${classname}List instance.
	 *
	 * @uses ${classname}List::$order
	 * @uses ${classname}List::$filter
	 * @return void
	 */
	 ...
	 *
	 * @uses ${classname}List::$paging
	 * @uses ${classname}List::$paging_page
	 ...
	 *
	 * @uses ${classname}List::_getDao()
	 * @uses ${classname}List::$dao
	 * @uses ${classname}List::$filter
	 * @uses DAO_${classname}List::getListCount()
	 * @return integer number of objects in the list
	 */
	 ...
	 * @uses ${classname}List::$view
	 * @uses ${classname}List::$dao
	 * @uses ${classname}::getXML()
	 * @uses Query::getXML()
	 * @uses DAO_${classname}List::getList()
	 * @uses ${classname}ViewList::getListHelper()
	 * @uses ${classname}ViewList::getViewXML()
