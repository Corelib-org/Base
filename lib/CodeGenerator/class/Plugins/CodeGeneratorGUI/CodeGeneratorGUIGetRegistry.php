...
//*****************************************************************//
//************** CodeGeneratorGUIGetRegistry class ****************//
//*****************************************************************//
/**
 ...
 * @since Version 5.0
 */
class CodeGeneratorGUIGetRegistry extends CodeGeneratorGUIFilePHP {

	/**
	 * @var CodeGeneratorGUIGet
	 */
	private $get = null;

	//*****************************************************************//
	//************ CodeGeneratorGUIGetRegistry methods ****************//
	//*****************************************************************//
	/**
	...
	public function generate(){
		...
		if($list->length > 0){
			for($i = 0; $i < $list->length; $i++){
				if(in_array($list->item($i)->nodeName, array('edit','delete','view'))){
					$title = '$pages[] = array(';
					$type = '\'type\' => \'regex\','."\n";
